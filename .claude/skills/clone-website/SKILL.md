...
3. **Website Type Analysis** (新增关键步骤)
   - Run website type detection for each URL: `node scripts/website-type-detector.js <url>`
   - Analyze results in `docs/research/website-type-analysis.json`
   - Classify each site: Blog (Technical/Personal/News), E-commerce, Corporate, Portfolio, etc.
   - Generate type-specific optimization strategy
   - Store strategy in `docs/research/cloning-strategy.md`
...
## Type-Optimized Cloning

Based on the website type analysis from Pre-Flight step 3, adjust your cloning strategy to focus on type-relevant features and components.

### Blog Websites (Technical/Personal/News/Corporate)

**Priority Components:**
1. **Article Content Template** — Full-width content area with proper typography
2. **Article List/Card** — Grid/list of articles with metadata
3. **Sidebar Widgets** — Categories, tags, recent posts, author bio
4. **Comments System** — Threaded comments with user avatars
5. **Pagination/Navigation** — Next/prev, numbered pages, infinite scroll
6. **Author Section** — Bio, social links, contribution history
7. **Tag/Category System** — Cloud, list, or hierarchical navigation

**Content Focus:**
- Extract actual article text with proper Markdown formatting
- Preserve code blocks with syntax highlighting
- Capture images with captions and alt text
- Extract metadata: author, date, read time, tags, categories
- Identify related articles or "read next" suggestions

**SEO & Discovery:**
- Generate Article/BlogPosting structured data
- Create RSS/Atom feeds if present on original
...
**Priority Components:**
1. **Product Grid** — Cards with images, prices, ratings
2. **Product Detail Page** — Images gallery, description, specs, reviews
3. **Shopping Cart** — Quantity controls, summary, checkout flow
4. **Filters & Sorting** — Category filters, price range, attributes
5. **Checkout Process** — Multi-step form, payment options

**Content Focus:**
- Extract product data with variants (sizes, colors)
- Capture high-quality product images
- Preserve customer reviews and ratings
...
2. **Services/Features** — Grid/list of offerings
3. **Team/About** — Employee profiles, company story
4. **Contact Forms** — Inquiry forms, location maps
...
**Priority Components:**
1. **Project Gallery** — Filterable grid of work samples
2. **Case Study Pages** — Detailed project breakdowns
3. **Skills/Technologies** — Visual representation of expertise
4. **About/Contact** — Personal introduction, availability

**Content Focus:**
- High-quality project images and videos
- Project descriptions with outcomes/results
- Technology stack visualization
- Client testimonials

### Implementation Strategy

1. **Review `website-type-analysis.json`** before starting Phase 1
2. **Adjust component extraction order** based on type priorities
3. **Allocate more time** to type-critical features
4. **Use type-specific templates** when available
5. **Validate** that all type-essential features are implemented

### Quality Assurance by Type

**Blog QA Checklist:**
- [ ] Article content renders correctly with proper formatting
- [ ] Code blocks have syntax highlighting
- [ ] Comments system functional (if applicable)
- [ ] Pagination works across all pages
- [ ] RSS feed generates correctly
- [ ] Social sharing buttons work

**E-commerce QA Checklist:**
- [ ] Product images load at appropriate sizes
- [ ] Price display is consistent
- [ ] Add-to-cart functionality works
- [ ] Filters and sorting operate correctly
- [ ] Checkout flow is smooth

**Document all type-specific validations** in `docs/research/type-qa.md`
